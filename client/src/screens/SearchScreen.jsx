...
const SearchScreen = () => {
    ...
    useEffect(() => {
		const fetchData = async () => {
			...
			try {
				console.log("fetching shit for search screen")

				// http://localhost:5000/api/products/search?page=${page}&query=${query}&category=${category}&price=${price}&rating=${rating}&order=${order} for local server
				// https://amazon-clone-1zgp.onrender.com/api/products/search?page=${page}&query=${query}&category=${category}&price=${price}&rating=${rating}&order=${order} for remote server
				const response = await fetch(`https://amazon-clone-1zgp.onrender.com/api/products/search?page=${page}&query=${query}&category=${category}&price=${price}&rating=${rating}&order=${order}`, {
					method: 'GET',
					// headers: {
